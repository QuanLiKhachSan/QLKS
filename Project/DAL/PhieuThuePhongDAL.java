...
public class PhieuThuePhongDAL extends DataAccessHelper {
    ...
    public boolean themPhieuMoi(String maphong, String makh, String soLuong, String ngoaiquoc, String manv, String ngayBD){
        String SQL = "insert into PHIEUTHUEPHONG(MaPhong,MaKh,SoLuongKH,KhachNuocNgoai,NgayBDThue,MaNV,TinhTrangPhieu) values('"+maphong+"','"+makh+"',"+soLuong+","+ngoaiquoc+",'"+ngayBD+"','"+manv+"','1')";
        try{
            getConnect();
    ...
    public PhieuThuePhong layThongTin(String maphieu){
        String SQL = "Select MaPhong, MaKH,NgayBDThue,KhachNuocNgoai,SoLuongKH from PhieuThuePhong where MaPhieuThue="+maphieu;
